...
| C-005 Multiple self-hosted open-source project-management substitutes already exist. | fact | E-011, E-012, E-013, E-014 | Resolved |
| C-006 A narrow clean-room product can differentiate on interaction fidelity plus ownership. | inference | E-002 through E-014, E-020 through E-023 | Supported; product outcomes remain the validation boundary |
| C-007 PostgreSQL supports database-level row security and indexed full-text search. | fact | E-016, E-017 | Resolved technical fact; architecture use superseded by CT-79 |
...
| C-017 Knowledge workers report goal fragmentation, inconsistent tracking, duplicate work, and information-retrieval friction. | fact | E-023 | Resolved with vendor conflict labeled |
| C-018 The stable migration-critical top-three set is issue lifecycle, find/focus, and project/milestone planning; ownership/recovery and traceability remain release-critical. | inference | E-001, E-020 through E-023 | Resolved by CT-77 scoring and sensitivity analysis |
| C-019 SQLite is an appropriate embedded application-file store for a serialized single-owner local workload and supports online backup. | fact | E-024, E-025, E-026 | Resolved capability; CT-80/82 own product proof |
| C-020 One Node 24 loopback process and SQLite file can preserve accepted behavior at the personal workload without Docker or PostgreSQL. | assumption | E-001, E-024, E-025, E-026 | CT-80, CT-81, and CT-82 |

Every uncertain material claim has exactly one Control Tower resolution action. The source register retains URL, path, type, verification, and public/private status. CT-1 is canceled and its empty interview kit is historical, not evidence.
