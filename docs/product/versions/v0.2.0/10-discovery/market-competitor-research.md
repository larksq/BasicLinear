...
Linear is the direct hosted experience substitute. Its official pricing page showed Free, Basic at $10 per user/month, and Business at $16 per user/month when observed. Plane is the strongest open-source/cloud substitute and markets per-seat plans starting above the sponsor's monthly price. Self-hosting OpenLinear remains the zero-subscription alternative for users willing to operate it.

The evidence does not establish that price alone will cause switching. Hosted incumbents offer broader integrations, administration, and mature collaboration. OpenLinear should compete on a compact combination: product-management focus, source availability, continuity with the local product, low price, and a narrow automation contract.
...
| Ownership | Hosted data remains exportable and local OpenLinear remains an alternative | Export acceptance and documented migration boundary |
...
The annual price equals six months of the monthly plan. That discount is sponsor-confirmed and unusually aggressive. Firebase App Hosting requires Blaze, Firestore charges by operations and storage, and payment processing adds variable cost. R-217 therefore makes cost-per-paid-seat and abuse controls release requirements. T-VALIDATE-PRICING must recommend keep/change/stop before public billing activation; it may not silently change sponsor-confirmed prices.
