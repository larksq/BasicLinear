...
|---|---|---|---|
| C-201: v0.2.0 must add a hosted product with the stated trial, prices, collaboration, API, MCP, and skills, while excluding agents and code review. | Fact (sponsor-confirmed) | E-201 | Scope authority |
...
| C-208: Current hosted alternatives charge materially more than the sponsor's $2/$12 offer. | Inference | E-214, E-215 | Low price is differentiating but increases unit-economics risk |
